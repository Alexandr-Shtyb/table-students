...
const students = [
    new Student('Милов', 'Александр', 'Григорьевич', 'Прикладная' +
        ' информатика', new Date(2001, 2, 11), 2019),
    new Student('Лимонова', 'Анна', 'Александровна', 'Экономика',
        new Date(2002, 3, 20), 2020),
    new Student('Бухов', 'Алексей', 'Алексеевич', 'Юриспруденция',
        new Date(1999, 8, 16), 2017)
];
    ...
    .addField('#input-birth-date', [
        ...
        },
        {
            ...
            validator: () => {
                ...
                return yearFromStr >= 1900;
            },
            errorMessage: 'Дата рождения находится в диапазоне от 01.01.1900' +
                ' до текущей даты',
        }
    ])
